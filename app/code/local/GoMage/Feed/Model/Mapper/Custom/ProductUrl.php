 ...
 */
class GoMage_Feed_Model_Mapper_Custom_ProductUrl implements GoMage_Feed_Model_Mapper_Custom_CustomMapperInterface
{
    ...
    {
        return Mage::helper('gomage_feed')->__('Product URL');
    }
